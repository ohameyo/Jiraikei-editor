...
- [ ] [图层元素体验调教](tasks/layer-elements-tuning.md)
...
## P1 文字
- [x] [文字输入、字体与图层命名](tasks/text-fonts-and-input.md)
...
## P1 腮红
- [ ] [腮红识别失败与手动选区](tasks/blush-manual-region.md)（图层选区体验已合并进图层元素体验调教）

## P1 马赛克与贴纸
- [ ] [马赛克贴纸比例与预览](tasks/mosaic-sticker-shapes.md)（图层预览体验已合并进图层元素体验调教）

## P2 导出
- [ ] [移动端与 PC 导出体验](tasks/export-experience.md)
